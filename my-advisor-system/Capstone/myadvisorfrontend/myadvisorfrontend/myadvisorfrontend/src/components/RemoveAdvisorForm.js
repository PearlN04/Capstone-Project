...
const RemoveAdvisorForm = ({ onCancel ,onClose}) => {
    ...
    const handleSubmit = (event) => {
        ...
        fetch(`http://localhost:8080/advisor/delete/${peoplesoftID}`, {
            method: 'DELETE',
        })
        .then((response) => {
            if (response.ok) {
                setSnackbarMessage('Advisor deleted successfully');
                ...
                setSnackbarMessage('Failed to delete advisor');
...
export default RemoveAdvisorForm;